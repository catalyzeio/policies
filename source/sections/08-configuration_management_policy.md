...
6. Tooling to generate an up-to-date inventory of systems, including corresponding architecture diagrams for related products and services, is hosted on GitLab.
   ...
   * These scripts are used to generate the diagrams and asset lists required by the Risk Assessment phase of WatchTower's Risk Management procedures ([§3.3.1](#3.3-risk-management-procedures)).
