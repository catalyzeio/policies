...
* On all production systems and applications with privileged administrative access in the Bind environment, password configurations are set to require that passwords are a minimum of 10 character length (14 for AWS IAM users), 90 day password expiration, account lockout after 5 invalid attempts for 20 minutes, password history of last 24 passwords remembered, and account lockout after 15 minutes of inactivity.
