...
* *Application*: An application hosted by Bind, either maintained and created by Bind, or maintained and created by a Customer or Partner.
...
* *Backup Service*: A logging service for unifying system and application logs, encrypting them, and providing a dashboard for them. Offered with all Bind Add-ons and as an option for PaaS Customers.
...
* *IDS Service*: An Intrusion Detection Service for providing IDS notification to customers in the case of suspicious activity. Offered with all Bind Add-ons and as an option for PaaS Customers.
...
* *Logging Service*: A logging service for unifying system and application logs, encrypting them, and providing a dashboard for them. Offered with all Bind Add-ons and as an option for PaaS Customers.
...
* *Partner*: Contractual bound 3rd party vendor with integration with the Bind Platform. May offer Add-on services.
