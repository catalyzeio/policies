# 24. HIPAA Mappings to Bind Controls

Below is a list of HIPAA Safeguards and Requirements and the Bind controls in place to meet those.

| **Administrative Controls** HIPAA Rule | Bind Control
--- | ---
...
| **Physical Safeguards** HIPAA Rule | Bind Control
--- | ---
...
| **Technical Safeguards** HIPAA Rule | Bind Control
---------------- | ----------------
