...
The current Bind Privacy Officer is Travis Good ([travis@Bind.com](mailto:travis@Bind.com)).
...
The current Bind Security Officer is Adam Leko ([adam@Bind.com](mailto:adam@Bind.com)).
